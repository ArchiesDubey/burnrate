            ...
            changes: [
                ReleaseNote.Change(
                    ...
                    detail: "The figure came from a file Codex writes during a "
                          ...
                          + "it — three days stale in one case. Burnrate now "
        ...
        ReleaseNote(
            ...
            changes: [
                ReleaseNote.Change(
                    ...
                    detail: "Google will not answer Burnrate directly, so it asks "
            ...
            changes: [
                ...
                ReleaseNote.Change(
                    ...
                    detail: "Each read from the tool already signed in on this Mac. "
                          + "Burnrate never asks for a password."
                ),
                ReleaseNote.Change(
                    title: "Choose where Burnrate appears",
