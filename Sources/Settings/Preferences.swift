...
final class Preferences: ObservableObject {
    ...
    /// The bundle identifiers this app has carried before, most recent first.
    ///
    ...
    static func migrateFromPreviousName(into defaults: UserDefaults = .standard,
        ...
        let candidates = domain.map { [$0] } ?? Self.previousDomains
        guard let old = candidates.lazy
    ...
    static func eraseAllData() {
        let bundleID = Bundle.main.bundleIdentifier ?? "com.burnrate.burnrate"
    ...
    private func applyLaunchAtLogin() {
        do {
            ...
            launchAtLoginProblem = "macOS refused this — try moving Burnrate to /Applications."
